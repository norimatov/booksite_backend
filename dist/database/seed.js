...
const book_entity_1 = require("../modules/books/book.entity");
async function seed() {
    await typeorm_config_1.default.initialize();
    const categoryRepo = typeorm_config_1.default.getRepository(category_entity_1.Category);
    const bookRepo = typeorm_config_1.default.getRepository(book_entity_1.Book);
    ...
    const cover = (seedName) => `https://picsum.photos/seed/${seedName}/400/600`;
    const booksData = [
        {
            ...
            totalPages: 240,
            isPremiumOnly: false,
            format: book_entity_1.BookFormat.TEXT,
        ...
        },
        {
            ...
            totalPages: 320,
            isPremiumOnly: true,
            format: book_entity_1.BookFormat.BOTH,
    ...
    for (const b of booksData) {
        ...
        if (!exists) {
            ...
            await bookRepo.update(exists.id, b);
        }
    }
